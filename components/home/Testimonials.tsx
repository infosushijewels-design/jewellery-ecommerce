export default function Testimonials() {
  return (
    <section className="py-20 bg-surface-container-low" id="testimonials">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="font-headline-lg text-headline-lg text-primary">Words from Our Patrons</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Review 1 */}
          <div className="bg-surface p-8 rounded-2xl border border-outline-variant/40 relative">
            ...
            <div>
              <p className="font-headline-sm text-[15px] text-primary">Ananya Sharma</p>
              <p className="font-label-sm text-[11px] text-outline mt-0.5">Verified Buyer • Mumbai</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-outline-variant/40 relative">
            ...
            <div>
              <p className="font-headline-sm text-[15px] text-primary">Dr. Rakesh Mehta</p>
              <p className="font-label-sm text-[11px] text-outline mt-0.5">Verified Buyer • Delhi</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-outline-variant/40 relative">
            ...
            <div>
              <p className="font-headline-sm text-[15px] text-primary">Priya Patel</p>
              <p className="font-label-sm text-[11px] text-outline mt-0.5">Verified Buyer • Bangalore</p>
            </div>
          </div>
        </div>
      </div>
