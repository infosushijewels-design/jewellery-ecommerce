...
export default function Categories() {
  return (
    <section className="py-16 max-w-[1440px] mx-auto px-6 lg:px-16" id="categories">
      <div className="text-center max-w-xl mx-auto mb-12">
        <span className="font-label-sm text-label-sm text-secondary tracking-widest uppercase">The Silhouettes</span>
        <h2 className="font-headline-lg text-headline-lg text-primary mt-1">Shop by Category</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-6 text-center">
        ...
        <Link className="group flex flex-col items-center" href="/category/rings">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors font-semibold">Rings</span>
        </Link>
        {/* 2: Earrings */}
        <Link className="group flex flex-col items-center" href="/category/earrings">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Earrings</span>
        </Link>
        {/* 3: Necklaces */}
        <Link className="group flex flex-col items-center" href="/category/necklaces">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Necklaces</span>
        </Link>
        {/* 4: Bracelets */}
        <Link className="group flex flex-col items-center" href="/category/bracelets">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Bracelets</span>
        </Link>
        {/* 5: Bangles */}
        <Link className="group flex flex-col items-center" href="/category/bangles">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Bangles</span>
        </Link>
        {/* 6: Solitaires */}
        <Link className="group flex flex-col items-center" href="/category/rings">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Solitaires</span>
        </Link>
        {/* 7: Mangalsutras */}
        <Link className="group flex flex-col items-center" href="/category/necklaces">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Mangalsutras</span>
        </Link>
        {/* 8: Gold Coins */}
        <Link className="group flex flex-col items-center" href="/category/rings">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-surface-container border border-outline-variant/60 p-1 group-hover:border-secondary transition-colors duration-300">
          ...
          <span className="font-label-lg text-label-lg text-primary mt-3 group-hover:text-secondary transition-colors">Gold Coins</span>
        </Link>
      </div>
    </section>
  );
