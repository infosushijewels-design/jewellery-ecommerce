...
export default function Categories() {
  return (
    <section className="py-10 sm:py-16 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-16" id="categories">
      ...
      <div className="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-6 text-center">
        {/* 1: Rings */}
        <Link className="group flex flex-col items-center" href="/category/rings">
          ...
          <span className="font-label-sm sm:font-label-lg text-[10px] sm:text-label-lg text-primary mt-2 sm:mt-3 group-hover:text-secondary transition-colors font-semibold">Rings</span>
        </Link>
        {/* 2: Earrings */}
        <Link className="group flex flex-col items-center" href="/category/earrings">
          ...
          <span className="font-label-sm sm:font-label-lg text-[10px] sm:text-label-lg text-primary mt-2 sm:mt-3 group-hover:text-secondary transition-colors">Earrings</span>
        </Link>
        {/* 3: Necklaces */}
        <Link className="group flex flex-col items-center" href="/category/necklaces">
          ...
          <span className="font-label-sm sm:font-label-lg text-[10px] sm:text-label-lg text-primary mt-2 sm:mt-3 group-hover:text-secondary transition-colors">Necklaces</span>
        </Link>
        {/* 4: Bracelets */}
        <Link className="group flex flex-col items-center" href="/category/bracelets">
          ...
          <span className="font-label-sm sm:font-label-lg text-[10px] sm:text-label-lg text-primary mt-2 sm:mt-3 group-hover:text-secondary transition-colors">Bracelets</span>
        </Link>
        {/* 5: Bangles */}
        ...
        <Link className="group flex flex-col items-center" href="/category/rings">
          ...
          <span className="font-label-sm sm:font-label-lg text-[10px] sm:text-label-lg text-primary mt-2 sm:mt-3 group-hover:text-secondary transition-colors">Gold Coins</span>
        </Link>
      </div>
    </section>
  );
