  ...
  return (
    <section className="py-20 max-w-[1440px] mx-auto px-6 lg:px-16">
      <div className="text-center max-w-xl mx-auto mb-12">
        ...
        <h2 className="font-headline-lg text-headline-lg text-primary mt-1">Most Loved Creations</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Item 1 */}
        <div className="bg-surface-container-low rounded-xl border border-outline-variant/40 p-4 flex flex-col justify-between hover:shadow-[0_8px_24px_-4px_rgba(45,32,36,0.06)] transition-all">
          <div className="aspect-[3/4] bg-surface rounded-lg overflow-hidden relative mb-4">
            <span className="absolute top-3 left-3 z-10 font-label-sm text-label-sm bg-surface-container text-primary px-2 py-0.5 rounded-full border border-secondary/40 font-medium">Bestseller</span>
          ...
          <div>
            <div className="flex items-center gap-1 text-secondary mb-1">
              ...
              <span className="font-label-sm text-[11px] text-outline">(128 reviews)</span>
            </div>
            <h3 className="font-headline-sm text-headline-sm text-primary">Anya Pear Solitaire Pendant</h3>
            <p className="font-body-md text-body-md text-primary font-semibold mt-1">₹39,800</p>
          </div>
        </div>
        ...
        <div className="bg-surface-container-low rounded-xl border border-outline-variant/40 p-4 flex flex-col justify-between hover:shadow-[0_8px_24px_-4px_rgba(45,32,36,0.06)] transition-all">
          ...
          <div>
            <div className="flex items-center gap-1 text-secondary mb-1">
              <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
              <span className="font-label-sm text-label-sm text-on-surface font-semibold">5.0</span>
              <span className="font-label-sm text-[11px] text-outline">(342 reviews)</span>
            </div>
            <h3 className="font-headline-sm text-headline-sm text-primary">Lumina Classic Diamond Studs</h3>
            <p className="font-body-md text-body-md text-primary font-semibold mt-1">₹29,500</p>
          </div>
        </div>
        ...
        <div className="bg-surface-container-low rounded-xl border border-outline-variant/40 p-4 flex flex-col justify-between hover:shadow-[0_8px_24px_-4px_rgba(45,32,36,0.06)] transition-all">
          ...
          <div>
            <div className="flex items-center gap-1 text-secondary mb-1">
              <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
              <span className="font-label-sm text-label-sm text-on-surface font-semibold">4.8</span>
              <span className="font-label-sm text-[11px] text-outline">(96 reviews)</span>
            </div>
            <h3 className="font-headline-sm text-headline-sm text-primary">Seraphina Chevron Gold Band</h3>
            <p className="font-body-md text-body-md text-primary font-semibold mt-1">₹22,400</p>
          </div>
        </div>
        ...
        <div className="bg-surface-container-low rounded-xl border border-outline-variant/40 p-4 flex flex-col justify-between hover:shadow-[0_8px_24px_-4px_rgba(45,32,36,0.06)] transition-all">
          ...
          <div>
            <div className="flex items-center gap-1 text-secondary mb-1">
              <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
              <span className="font-label-sm text-label-sm text-on-surface font-semibold">4.9</span>
              <span className="font-label-sm text-[11px] text-outline">(210 reviews)</span>
            </div>
            <h3 className="font-headline-sm text-headline-sm text-primary">Kashmiri Floral Gold Kada</h3>
            <p className="font-body-md text-body-md text-primary font-semibold mt-1">₹68,900</p>
          </div>
        </div>
      </div>
    </section>
