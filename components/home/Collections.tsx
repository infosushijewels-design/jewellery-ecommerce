export default function Collections() {
  return (
    <section className="py-20 bg-surface-container-low border-y border-outline-variant/30" id="collections">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="font-headline-lg text-headline-lg text-primary mt-1">Curated Collections</h2>
          ...
          <a className="mt-4 md:mt-0 font-label-lg text-label-lg text-primary hover:text-secondary flex items-center gap-1 group" href="#">
